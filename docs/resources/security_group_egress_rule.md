...
description: |-
  Manages one egress TCP/UDP rule in an iwinv security group.
---
...
The resource restores externally changed direction to `egress` with an in-place update and displays that change in plan.
