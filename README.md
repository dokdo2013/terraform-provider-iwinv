...
**현재 상태: Data Source 18개와 보안 그룹·ingress·egress·웹호스팅·DBMS·캐시·NAS 리소스 7개를 구현하고 실환경 검증했습니다. Registry 릴리스는 아직 없습니다.**
...
| [캐시 데이터 API 준비](design/ko/cache-data-api.md) | 상품·이미지 매니저 연결, 별도 키 인증과 이미지·폴더 검증 계획 |
...
| [릴리스 준비](design/ko/release-readiness.md) | 7개 대상 패키지·체크섬·격리 설치 검증과 남은 서명·Registry 조건 |
