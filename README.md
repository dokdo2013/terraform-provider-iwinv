...
**현재 상태: Data Source 7개와 보안 그룹·ingress·egress 리소스 3개를 구현하고 실환경 검증했습니다. Registry 릴리스는 아직 없습니다.**
...
| [호스팅 수명주기 설계](design/ko/webhosting-lifecycle.md) | 24시간 계정명 재사용 제한, 비밀번호·import·교체 검증 계획; 리소스 미등록 |
