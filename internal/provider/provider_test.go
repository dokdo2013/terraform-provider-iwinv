...
func TestProviderSchema(t *testing.T) {
	...
	if len(resp.ResourceSchemas) != 5 || resp.ResourceSchemas["iwinv_security_group"] == nil || len(resp.DataSourceSchemas) != 10 || resp.DataSourceSchemas["iwinv_availability_zones"] == nil {
