...
func TestProviderSchema(t *testing.T) {
	...
	if len(resp.ResourceSchemas) != 4 || resp.ResourceSchemas["iwinv_security_group"] == nil || len(resp.DataSourceSchemas) != 9 || resp.DataSourceSchemas["iwinv_availability_zones"] == nil {
