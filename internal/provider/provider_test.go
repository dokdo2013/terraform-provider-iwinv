...
func TestProviderSchema(t *testing.T) {
	...
	if len(resp.ResourceSchemas) != 7 || resp.ResourceSchemas["iwinv_security_group"] == nil || len(resp.DataSourceSchemas) != 14 || resp.DataSourceSchemas["iwinv_availability_zones"] == nil {
