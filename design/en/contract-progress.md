...
Console ownership, actual IDs, addresses and raw responses remain in a mode-0600 journal outside Git. This test server's deletion requires the console password check; cleanup or billing termination is not claimed before acknowledgement and absence are verified.
