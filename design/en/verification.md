...
**Authenticated read acceptance passed for nine data sources, and lifecycle acceptance passed for security-group attributes and independent ingress/egress rules, plus SHARE PHP 8.4 hosting (T060). Compute and remaining managed-resource gates have not passed.**
