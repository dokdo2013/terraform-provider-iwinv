...
- Overview and capability pages now exist in both languages. Official format checks and all 56 body previews passed; finish full narrative parity and published Registry navigation/link checks (T052). See the documentation policy for the exact preview snapshot and limits.
