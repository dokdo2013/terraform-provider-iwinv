...
| C27 | OAuth/S256/mcp:tools and temporary registration 201 observed; no consent/tool list, registration DELETE 404 and management GET 200 | [MCP audit](mcp-audit.md): resolve cleanup/consent before tools/list comparison; no Provider runtime dependency |
