...
| C27 | MCP OAuth·S256·mcp:tools와 임시 등록 201 확인; 동의·도구 목록 미확인, 등록 삭제 404/관리 조회 200 | [MCP 조사](mcp-audit.md): 등록 정리·OAuth 동의 후 tools/list 대조; Provider 실행 의존성으로 쓰지 않음 |
