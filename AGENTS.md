...
- This repository has a read-only API contract client and verification tooling. Do not claim that a provider binary, resource, Registry release, or live acceptance test exists before it does.
