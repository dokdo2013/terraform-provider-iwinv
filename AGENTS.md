...
- This repository has a development provider, sixteen live-tested zone/image/instance-type/SSH-key/hosting/DBMS/cache/NAS-catalog/billing/security-group data sources, seven live-tested security-group/rule/webhosting/DBMS/cache/NAS resources, and contract tooling. Attachments and other managed resources remain unimplemented. No Registry release exists yet. Keep claims aligned with the implementation ledger and evidence.
