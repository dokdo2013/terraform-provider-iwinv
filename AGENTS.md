...
- This repository has a development provider, seven live-tested zone/image/instance-type/SSH-key data sources, one live-tested security-group attribute resource, and contract tooling. Rules, attachments and other managed resources remain unimplemented. No Registry release exists yet. Keep claims aligned with the implementation ledger and evidence.
