...
- This repository has a development provider, a live-tested availability-zone data source and contract tooling. Managed resources and Registry releases do not exist yet. Keep claims aligned with the implementation ledger and evidence.
