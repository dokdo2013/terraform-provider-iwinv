...
- This repository has a development provider, ten live-tested zone/image/instance-type/SSH-key/hosting/DBMS-catalog data sources, six live-tested security-group/rule/webhosting/DBMS/cache resources, and contract tooling. Attachments and other managed resources remain unimplemented. No Registry release exists yet. Keep claims aligned with the implementation ledger and evidence.
