...
- This repository has a development provider, seven live-tested zone/image/instance-type/SSH-key data sources, three live-tested security-group/rule resources, and contract tooling. Attachments and other managed resources remain unimplemented. No Registry release exists yet. Keep claims aligned with the implementation ledger and evidence.
